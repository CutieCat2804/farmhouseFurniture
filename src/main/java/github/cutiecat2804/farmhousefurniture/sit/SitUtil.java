...
public class SitUtil {
     ...
     */
    public static void removeSitEntity(Level world, BlockPos pos) {
        if (!world.isClientSide) {
            ResourceLocation id = getDimensionTypeId(world);
     ...
     * @return true if a player is sitting at the given position in the given world, false otherwise. This is always false on
     *         the client.
     */
